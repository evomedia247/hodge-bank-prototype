...
$(document).ready(function () {
	...
	var appViewModel = function () {
		...
		incomeNavigation = function() {
			if (vm.incomeModel().includes(1)) {
				window.location.href = "/income1.html";
			} else if (vm.incomeModel().includes(2)) {
				window.location.href = "/income2a.html";
			} else if (vm.incomeModel().includes(3)) {
				window.location.href = "/income2b.html";
			} else if (vm.incomeModel().includes(4)) {
				window.location.href = "/income2c.html";
			} else if (vm.incomeModel().includes(5)) {
				window.location.href = "/income2d.html";
			} else if (vm.incomeModel().includes(6)) {
				window.location.href = "/income3.html";
			} else if (vm.incomeModel().includes(7)) {
				window.location.href = "/income4.html";
			} else if (vm.incomeModel().includes(8)) {
				window.location.href = "/income5.html";
			} else if (vm.incomeModel().includes(9)) {
				window.location.href = "/income6.html";
			} else if (vm.incomeModel().includes(10)) {
				window.location.href = "/income7.html";
			} else if (vm.incomeModel().includes(11)) {
