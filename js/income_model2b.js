...
$(document).ready(function () {
	...
	var Job = function (_occupation, _years, _retirement, _salarylatest, _salaryprevious, _dividendslatest, _dividendsprevious) {
		var self = this;
		self.occupation = ko.observable(_occupation);
		self.years = ko.observable(_years);
		self.retirement = ko.observable(_retirement);
		self.salarylatest = ko.observable(_salarylatest);
		self.salaryprevious = ko.observable(_salaryprevious);
		self.dividendslatest = ko.observable(_dividendslatest);
		self.dividendsprevious = ko.observable(_dividendsprevious);
	};

	var joblist = [
		new Job("Engineer", "4", "60", "16000", "12000", "12000", "8000" ),
	];
	...
	var NewData = [new Job("Engineer", "8", "60", "30000", "24000", "30000", "24000"  )];
