...
$(document).ready(function () {
	...
	var Job = function (_occupation, _years, _retirement, _gross, _additional) {
		var self = this;
		self.occupation = ko.observable(_occupation);
		self.years = ko.observable(_years);
		self.retirement = ko.observable(_retirement);
		self.gross = ko.observable(_gross);
		self.additional = ko.observable(_additional);
	};

	var joblist = [
		new Job("Marketing Assistant", "25", "57", "44000", "4000"  ),
	...
	var NewData = [new Job("Plumber", "30", "70", "52000", "2000" )];
