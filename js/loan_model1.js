...
$(document).ready(function () {
	...
	var data = [
		new personalLoan("Mortgage", "Joint", "89750", "550.00", "2022", "YES"  ),
	];

	var NewData = [new personalLoan("Mortgage", "One", "124000", "670.00", "2028", "NO" )];
	...
	var appViewModel = function () {
		...
		borrowingNavigation = function() {
			if (vm.BorrowingSwitcher().includes(2)) {
