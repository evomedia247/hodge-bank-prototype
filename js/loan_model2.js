...
$(document).ready(function () {
	...
	var data = [
		new personalLoan("Personal Loan", "Joint", "1400", "72.00", "2019", "YES" ),
		new personalLoan("Hire Purchase", "One", "6000", "21.00", "2019", "YES" ),
		new personalLoan("Hire Purchase", "One", "800", "40.00", "2019", "YES" ),
		new personalLoan("Personal Loan", "Two", "30", "5.00", "2019", "YES" )
	];

	var NewData = [new personalLoan("Personal Loan", "Joint", "1400", "72.00", "2019", "NO" )];
	...
	var NewData = [new personalLoan("Personal Loan", "Two", "90", "65.00", "2022", "YES" )];
	...
	var appViewModel = function () {
		...
		previousNavigation = function() {
			if (vm.BorrowingSwitcher().includes(1) || vm.BorrowingSwitcher().includes(9)) {
