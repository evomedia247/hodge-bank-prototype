...
$(document).ready(function () {
	...
	var data = [
		new personalLoan("Hire purchase", "Joint", "14000", "472.00", "2022", "YES" ),
		new personalLoan("Hire purchase", "One", "6000", "211.00", "2020", "YES" )
	];

	var NewData = [new personalLoan("Hire purchase", "Joint", "1400", "72.00", "2019", "NO" )];
	...
	var appViewModel = function () {
		...
		borrowingNavigation = function() {
			if (vm.BorrowingSwitcher().includes(4)) {
		...
		previousNavigation = function() {
			if (vm.BorrowingSwitcher().includes(2) || vm.BorrowingSwitcher().includes(10)) {
				window.location.href = "/borrowing2.html";
			} else if (vm.BorrowingSwitcher().includes(1) || vm.BorrowingSwitcher().includes(9)) {
