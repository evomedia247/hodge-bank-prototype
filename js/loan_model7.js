...
$(document).ready(function () {
	...
	var data = [
		new personalLoan("Mortgage", "One", "89000", "442.00", "2027", "YES" ),
	];

	var NewData = [new personalLoan("Mortgage", "Two", "190000", "600.00", "2032", "YES" )];
	...
	var appViewModel = function () {
		...
		borrowingNavigation = function() {
			if (vm.BorrowingSwitcher().includes(8)) {
		...
		previousNavigation = function() {
			if (vm.BorrowingSwitcher().includes(6)) {
